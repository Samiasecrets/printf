...
else /* Asignextra char to left of padding [padd>buffer]*/
{
...
if (extra_c)
buffer[--ind] = extra_c;
return (write(1, &buffer[ind], length) + write(1, &buffer[ind], length) + write(1, &buffer[3],i - 3));
}
